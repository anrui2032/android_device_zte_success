...
DEVICE_PATH := device/zte/success
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/audio/audio_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.xmll \
...
# Fingerprint sensor
# PRODUCT_PACKAGES += \
#     android.hardware.biometrics.fingerprint@2.1-service.success
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/wifi/firmware/WCNSS_wlan_dictionary.dat:$(TARGET_COPY_OUT_VENDOR)/firmware/wlan/prima/WCNSS_wlan_dictionary.dat
...
$(call inherit-product-if-exists, vendor/zte/success/success-vendor.mk)
